            ...
            <div className="flex flex-col items-center justify-center h-screen">
                <div className="w-full max-w-md bg-violet-50 rounded-lg shadow-md p-6">
                    ...
                    <form className="flex flex-col">
                        <input type="text" className="bg-white text-gray-900 border-0 rounded-md p-2 mb-4 focus:bg-gray-50 focus:outline-none focus:ring-1 focus:ring-blue-100 transition ease-in-out duration-150" placeholder="Full name"/>
